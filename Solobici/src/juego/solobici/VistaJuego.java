...
public class VistaJuego extends View {
	...
	private int numCoches = 5;		//N�mero inicial de Coches
	private int numMotos = 3;		//Fragmentos/Motos en que se dividir� un Coche

	// BICI //
	private Grafico bici;
	private int giroBici;			//Incremento en la direcci�n de la bici
	...
	//Momento en el que se realiz� el �ltimo proceso
	...
	public VistaJuego(Context contexto, AttributeSet atributos) {
		...
		//Creamos un vector para contener todos los coches que ir�n por la pantalla
		//y lo rellenamos con gráficos de coches
		// con valores aleatorios para su velocidad, direcci�n y rotaci�n.
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh) {
		...
		//Para la bici ponemos la posici�n central de la pantalla
	...
	protected synchronized void actualizaMovimiento() {
		...
		// No hacemos nada si el per�odo de proceso no se ha cumplido.
		if (ultimoProceso + PERIODO_PROCESO > ahora) {
			return;
		}
		// Para una ejecuci�n en tiempo real calculamos retardo
		double retardo = (ahora - ultimoProceso) / PERIODO_PROCESO;
		// Actualizamos la posici�n de la bici
